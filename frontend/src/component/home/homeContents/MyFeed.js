...
const MyFeed = () => {
    return (
        ...
        <br/>
            ...
            <span className="user_like"> <img className="icon" src="../.././img/like.png"/> 28 </span>
            <span className="user_like"><img className="icon" src="../.././img/comment.png"/> 81 </span>
            </div>
        ...
        <br/>
            ...
            <span className="user_like"> <img className="icon" src="../.././img/like.png"/> 5 </span>
            <span className="user_like"><img className="icon" src="../.././img/comment.png"/> 11 </span>
            </div>
        </div>
    );
}
